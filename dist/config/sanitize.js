...
const preferencesCollection_1 = __importDefault(require("../preferences/preferencesCollection"));
const migrationsCollection_1 = require("../database/migrations/migrationsCollection");
...
const sanitizeConfig = (incomingConfig) => {
    ...
    configWithDefaults.collections.push((0, preferencesCollection_1.default)(configWithDefaults));
    configWithDefaults.collections.push(migrationsCollection_1.migrationsCollection);
    configWithDefaults.collections = configWithDefaults.collections.map((collection) => (0, sanitize_1.default)(configWithDefaults, collection));
