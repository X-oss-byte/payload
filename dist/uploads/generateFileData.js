...
const generateFileData = async ({ config, collection: { config: collectionConfig, }, req, data, throwOnMissingFile, overwriteExistingFiles, }) => {
    ...
    try {
        ...
        if (!overwriteExistingFiles) {
            fsSafeName = await (0, getSafeFilename_1.default)(req.payload, collectionConfig.slug, staticPath, fsSafeName);
        }
