...
async function getSafeFileName(payload, collectionSlug, staticPath, desiredFilename) {
    let modifiedFilename = desiredFilename;
    // eslint-disable-next-line no-await-in-loop
    while (await (0, docWithFilenameExists_1.default)(payload, collectionSlug, staticPath, modifiedFilename) || await (0, fileExists_1.default)(`${staticPath}/${modifiedFilename}`)) {
