...
async function login(incomingArgs) {
    ...
    const { collection: { config: collectionConfig, }, data, req: { payload, payload: { secret, config, }, }, req, depth, overrideAccess, showHiddenFields, } = args;
    try {
        ...
        if (user && (0, isLocked_1.default)(user.lockUntil)) {
