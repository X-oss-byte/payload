...
const CheckboxInput = (props) => {
    ...
    return (react_1.default.createElement("div", { className: [
        ...
        react_1.default.createElement("div", { className: `${baseClass}__input` },
            react_1.default.createElement("input", { ref: inputRef, id: id, type: "checkbox", name: name, "aria-label": ariaLabel, checked: Boolean(checked), disabled: readOnly, onInput: onToggle }),
