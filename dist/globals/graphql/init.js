...
function initGlobalsGraphQL(payload) {
    Object.keys(payload.globals.config).forEach((slug) => {
        ...
        const { fields, versions, graphQL, } = global;
        if (graphQL === false) {
            return;
        }
        const formattedName = (graphQL === null || graphQL === void 0 ? void 0 : graphQL.name) ? graphQL.name : (0, pluralize_1.singular)((0, formatLabels_1.toWords)(global.slug, true));
