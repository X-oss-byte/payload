...
import FileGraphic from 'payload/src/admin/components/graphics/File';
import useThumbnail from 'payload/src/admin/hooks/useThumbnail';
...
import { DrawerToggler } from 'payload/src/admin/components/elements/Drawer';
