...
import { richText } from 'payload/src/fields/validations';
import useField from 'payload/src/admin/components/forms/useField';
import withCondition from 'payload/src/admin/components/forms/withCondition';
import Label from 'payload/src/admin/components/forms/Label';
import Error from 'payload/src/admin/components/forms/Error';
import defaultValue from 'payload/src/fields/richText/defaultValue';
import FieldDescription from 'payload/src/admin/components/forms/FieldDescription';
import { RichTextProps as Props } from 'payload/src/admin/components/forms/field-types/RichText/types';
import { RichTextElement, RichTextLeaf } from 'payload/src/fields/config/types';
import { getTranslation } from 'payload/src/utilities/getTranslation';
import { useEditDepth } from 'payload/src/admin/components/utilities/EditDepth';
...
export default withCondition(RichText); // TODO: Fix this
